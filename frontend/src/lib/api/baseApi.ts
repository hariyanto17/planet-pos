...
export const baseApi = createApi({
  ...
  tagTypes: ["User", "Category", "Product", "Table", "Tax", "Promotion", "Order", "Payment", "Reports", "Shifts", "Inventory", "Unit", "Warehouse", "Brand", "Material", "MaterialVariant", "Supplier", "Settings"],
  endpoints: () => ({}),
});
