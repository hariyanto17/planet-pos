...
export const getOperationalSummaryHandler = async (req: Request, res: Response) => {
  ...
  return responseHandler.ok(res, summary, "Concession operational summary retrieved successfully");
};
...
export const getAnalyticsDataHandler = async (req: Request, res: Response) => {
  ...
  return responseHandler.ok(res, analytics, "Concession analytics data retrieved successfully");
};

export const getActivityListHandler = async (req: Request, res: Response) => {
  const activities = await internalService.getActivityList();
  return responseHandler.ok(res, activities, "Concession activity retrieved successfully");
};
...
export const getTransactionsListHandler = async (req: Request, res: Response) => {
  ...
  return responseHandler.ok(res, result, "Concession transactions retrieved successfully");
};
