...
import { loginHandler, getMeHandler, changePasswordHandler, ssoCallbackHandler, ssoSyncHandler } from "./controller";
...
router.post("/sso/sync", catchAsync(ssoSyncHandler));
